...
O prazo estimado de entrega será informado no momento da contratação. Eventuais atrasos decorrentes de falta de informações, necessidade de esclarecimentos, problemas técnicos ou casos fortuitos / força maior poderão impactar o prazo inicialmente previsto.
...
A produção da música somente será iniciada após a confirmação do pagamento. Os pagamentos são processados por intermediadores especializados (ex.: Mercado Pago). A aprovação, recusa ou análise antifraude são de responsabilidade dos respectivos provedores de pagamento.

## 9. Direito de Arrependimento

Nos termos do artigo 49 do Código de Defesa do Consumidor, o cliente poderá exercer o direito de arrependimento em até 7 (sete) dias da contratação, desde que a produção da música ainda não tenha sido iniciada.

Uma vez iniciada a produção personalizada, considerando a natureza individual e exclusiva do serviço, o reembolso poderá ser limitado conforme a etapa de execução já realizada (ver Política de Reembolso e Cancelamento).

## 10. Propriedade Intelectual

Após a entrega e quitação integral do pedido, o cliente receberá licença de uso pessoal da música produzida. Salvo autorização expressa em contrário, a Fiz Música mantém os direitos relacionados aos processos criativos, tecnologias, modelos, metodologias e elementos operacionais utilizados na produção. É proibida a revenda ou exploração comercial da música sem autorização formal da Fiz Música (ver Licença de Uso da Música).
