...
async function processJob(supabase: ReturnType<typeof createServerClient>, job: any) {
  ...
  try {
    ...
    // Os ingredientes (cenas, narração, música) FICAM. Eles são o que permite
    // trocar uma cena e remontar sem regerar o resto — enquanto a peça está em
    // iteração, são o ativo mais valioso que existe. A limpeza acontece quando
    // a peça é publicada ou rejeitada, não quando o vídeo fica pronto.
